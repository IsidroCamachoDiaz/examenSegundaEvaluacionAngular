...
import { Firestore, QueryConstraint,addDoc,collection, collectionData, deleteDoc, doc, docData, query, setDoc, updateDoc, where } from '@angular/fire/firestore';
...
queyCollection2campos(coleccion:string,campo:string,valor:any,campo2:string,valor2:any){
  ...
  //Crea un nuevo documento Set
  newDocumentCandidato(doc1:Candidato,coleccion:string){
    const colecionRef=doc(this.fbs,coleccion,doc1.dni);
    return setDoc(colecionRef,doc);
  }
